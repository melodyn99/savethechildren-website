...
class Breadcrumb extends Component {
    ...
    renderSwitch = (currentPath) => {
        ...
        if (i18n.language === "en-US") switch (currentPath) {
            ...
            case 'contact-us': {
                return (<div><span><Link to="/">Chinese About Us</Link></span> > <span>Contact us</span></div>);
            }
            case 'sitemap': {
                return (<div><span><Link to="/">Chinese About Us</Link></span> > <span>Sitemap</span></div>);
            }
            ...
            // Primary School
            case 'primary-school-home': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span>Primary school</span></div>);
            }
            case 'primary-general-tips': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span><Link to={"/" + i18n.language + "/primary-school-home"}>Primary school</Link></span> > <span>General tips</span></div>);
            }
            case 'primary-social-media-user-guide': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span><Link to={"/" + i18n.language + "/primary-school-home"}>Primary school</Link></span> > <span>Social media user guide</span></div>);
            }
            case 'primary-quiz': {
            ...
            case 'primary-game': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span><Link to={"/" + i18n.language + "/primary-school-home"}>Primary school</Link></span> > <span>Netizen Adventure</span></div>);
            }
            case 'primary-netizen-pledge': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span><Link to={"/" + i18n.language + "/primary-school-home"}>Primary school</Link></span> > <span>The Netizen Pledge</span></div>);
            }

            // Secondary School
            case 'secondary-school-home': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span>Secondary school</span></div>);
            }
            case 'secondary-general-tips': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span><Link to={"/" + i18n.language + "/secondary-school-home"}>Secondary school</Link></span> > <span>General tips</span></div>);
            }
            case 'secondary-social-media-user-guide': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span><Link to={"/" + i18n.language + "/secondary-school-home"}>Secondary school</Link></span> > <span>Social media user guide</span></div>);
            }
            case 'secondary-quiz': {
            ...
            case 'secondary-game': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span><Link to={"/" + i18n.language + "/secondary-school-home"}>Secondary school</Link></span> > <span>Netizen Adventure</span></div>);
            }
            case 'secondary-netizen-pledge': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span><Link to={"/" + i18n.language + "/secondary-school-home"}>Secondary school</Link></span> > <span>The Netizen Pledge</span></div>);
            }

            // Parents
            case 'parents-home': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span>Parents</span></div>);
            }
            case 'parents-tips': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span><Link to={"/" + i18n.language + "/parents-home"}>Parents</Link></span> > <span>Parents tips</span></div>);
            }
            case 'parents-blog': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span><Link to={"/" + i18n.language + "/parents-home"}>Parents</Link></span> > <span>Blog</span></div>);
            }
            case 'parents-blog-detail': {
            ...
            case 'parents-more-resources': {
                return (<div><span><Link to="/">Chinese Resources for you</Link></span> > <span><Link to={"/" + i18n.language + "/parents-home"}>Parents</Link></span> > <span>More resources on parenting</span></div>);
            }

            /*** FEATURED ISSUES ***/
            case 'online-grooming': {
                return (<div><span><Link to="/">Chinese Featured Issues</Link></span> > <span>網路性誘拐</span></div>);
            }
            case 'sexting': {
                return (<div><span><Link to="/">Chinese Featured Issues</Link></span> > <span>色情短訊</span></div>);
            }
            case 'personal-privacy': {
                return (<div><span><Link to="/">Chinese Featured Issues</Link></span> > <span>Personal privacy</span></div>);
            }
            case 'legislations': {
                return (<div><span><Link to="/">Chinese Featured Issues</Link></span> > <span>Legislations</span></div>);
            }

            /*** RESEARCH FINDINGS ***/
            case 'our-research': {
                return (<div><span><Link to="/">Chinese Research Findings</Link></span> > <span>Our research</span></div>);
            }
            case 'other-findings': {
                return (<div><span><Link to="/">Chinese Research Findings</Link></span> > <span>Other findings</span></div>);
            }

            /*** OUR EVENTS ***/
            case 'events-safer-internet-day-2019': {
                return (<div><span><Link to="/">Chinese Our Events</Link></span> > <span>Safer Inernet Day 2019</span></div>);
            }
            case 'events-smart-netizen-competition': {
                return (<div><span><Link to="/">Chinese Our Events</Link></span> > <span>"The Smart Netizen" Character Design Competition</span></div>);
            }
            case 'events-training-workshops': {
                return (<div><span><Link to="/">Chinese Our Events</Link></span> > <span>Training workshops</span></div>);
            }

            case 'external-resources': {
                return (<div><span>Chinese External Resources</span></div>)
            }
